...
function PatientsList(props) {
    ...
    return (
        <div className="flex flex-col justify-start pl-5 rounded-2xl bg-gray-300 mt-4">
            ...
            <div className="patientsListWrapper ">
                {patientList !== undefined && patientList.length === 0 ? <div className='flex flex-row justify-between items-center w-full my-5 text-headingblue font-poppins'>No patients found...</div> : null}
